...
The following example clones the "[Bluetooth&reg; LE multi beacon](https://github.com/Infineon/mtb-example-psoc-edge-btstack-multi-beacon)" application with the desired name "BluetoothLEMultiBeacon" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-btstack-multi-beacon --user-app-name BluetoothLEMultiBeacon --target-dir "C:/mtb_projects"
   ```
